...
tweenCamera('', '', 1, function() {}, 0);

models = 2;
numbertomodel = dictCreateWith(['0', '1', 2, 3, 4], getObjectsFrom(['GROUP', 'ModelCarousel'], 'ALL'));

console.log(dictGet(numbertomodel, '1'));
